...
function draw() {
 ...
 StopSpeed();
  ...
  if(keyDown("space") && monkey.y > 320 || touches.length > 0 && monkey.y > 320){
    monkey.velocityY = -18;
...
(function YO() {
  ...
  po.async = true;
  po.src = 'https://www.gstatic.com/recaptcha/releases/qc5B-qjP0QEimFYUxcpWJy5B/recaptcha__en.js';
  po.crossOrigin = 'anonymous';
  po.integrity = 'sha384-EauiKN7dy30bq/wDo7lcvebLQr7wwQPtEV6A1G43RAWnhPwxWZFCCTOT/hE+ffe3';
